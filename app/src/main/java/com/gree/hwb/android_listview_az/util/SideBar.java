...
import com.gree.hwb.android_listview_az.R;
...
public class SideBar extends View
{
	...
	protected void onDraw(Canvas canvas)
	{
		...
		{
			paint.setColor(Color.rgb(33, 65, 98));//设置A~Z字体颜色
			//paint.setColor(Color.WHITE);
			paint.setTypeface(Typeface.DEFAULT_BOLD);//设置A~Z字体
			paint.setAntiAlias(true);//设置抗锯齿
			paint.setTextSize(30);
			// 选中的状态
			if (i == choose)
			{
				paint.setColor(Color.parseColor("#3399ff"));//A~Z选中之后的颜色设置
